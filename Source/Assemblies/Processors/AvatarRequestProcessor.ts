...
import { LegacyCacheRepository } from 'Assemblies/Caching/LegacyCacheRepository';
...
export class AvatarRequestProcessor {
	...
	private static readonly Legacy2CharacterFetchCacheRepo: LegacyCacheRepository = new LegacyCacheRepository(
		'Legacy2CharacterFetchCacheRepo',
		CachePolicy.StaleAfterOneMinute,
	);
}
