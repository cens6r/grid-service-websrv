 ...
 * Description: Tries to write the file `hosts.txt` to `/etc/hosts` (Linux/Darwin) or `C:\Windows\System32\Drivers\etc\hosts`, this will require root, so you will have to either run the full job with sudo
